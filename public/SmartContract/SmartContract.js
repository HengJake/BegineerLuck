...
async function displaySingleNFT(metadata, id) {
...
async function displayNFT(metadata, id) {
  ...
  if (owner == "0x0000000000000000000000000000000000000000") {
    card.classList.add("notowned");
  } else if (owner.toLowerCase() == userAddress.toLowerCase()) {
    card.classList.add("owned");
  } else {
    card.classList.add("ownedbyother");
  }
  ...
  const idShowCase = document.createElement("p");
  idShowCase.textContent = "ID : " + id;
