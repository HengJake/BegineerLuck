    ...
    <div class="flex-column flex-center">
        ...
        <div class="SignUp_Container flex-center flex-column">
            ...
            <form class="w-100" method="POST" action="auth_backend.php?action=signup" id="signupForm" enctype="multipart/form-data">
                ...
                <div class="SignUp_Container2 scroll-container">
                    <div class="mb-1 SignUp_Input">
                    ...
                    <div class="mb-1 SignUp_Input">
                        ...
                        <input class="mb-1" type="text" id="wallet_address" name="wallet_address"
                        ...
                        <a href="#" id="createWalletLink">Connect Wallet</a>
                    </div>
